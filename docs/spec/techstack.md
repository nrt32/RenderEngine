...
| Logging | **spdlog v1.14.1** (commit `27cb4c76708608465c413f6d0e6b8d99a4d84302` via `git ls-remote --tags`, iteration 4 #1) `GIT_TAG v1.14.1` | Lightweight OSS logging: trace/debug/info/warn/error/fatal; console/file sinks |
