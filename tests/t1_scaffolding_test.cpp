...
TEST(T1Scaffolding, GateEnvironmentSourced) {
    ...
    // including the utils/ module added in V2.1, scene/broker modules added in V3 (SPEC §3),
    // and test_utils peer lib present from start (empty until T18, harmless pre-existing).
